    ...
    <div className={styles.adminDashboard8}>
          ...
          <div className={styles.adminDashboard5}>
            <div className={styles.adminDashboard}>
              ...
              <div className={styles.container3}>
                <img src="../image/mi2ttl3f-epadpo4.svg" className={styles.icon} />
              </div>
            </div>
            <div className={styles.adminDashboard2}>
              ...
              <div className={styles.container5}>
                <img src="../image/mi2ttl3g-opndvf9.svg" className={styles.icon} />
              </div>
            </div>
            <div className={styles.adminDashboard3}>
              ...
              <div className={styles.container7}>
                <img src="../image/mi2ttl3g-vfr9kb8.svg" className={styles.icon} />
              </div>
            </div>
            <div className={styles.adminDashboard4}>
              ...
              <div className={styles.container9}>
                <img src="../image/mi2ttl3g-5mmreo4.svg" className={styles.icon} />
              </div>
            </div>
          </div>
            ...
            <div className={styles.card2}>
              ...
              <div className={styles.cardContent}>
                <div className={styles.alert}>
                  <img
                    src="../image/mi2ttl3g-688av5h.svg"
                ...
                <div className={styles.alert2}>
                  <img
                    src="../image/mi2ttl3g-a1r0gi6.svg"
                    className={styles.icon2}
                  />
                ...
                <div className={styles.alert2}>
                  <img
                    src="../image/mi2ttl3g-evocddf.svg"
                    className={styles.icon2}
                  />
                  <p className={styles.a5NuevasSolicitudesD}>
      ...
      <div className={styles.container20}>
        <div className={styles.container18}>
          <img src="../image/mi2ttl3g-v9cl2qa.svg" className={styles.icon3} />
        ...
        <div className={styles.container19}>
          <div className={styles.button}>
            <img src="../image/mi2ttl3g-1nzc4wg.svg" className={styles.icon4} />
            <p className={styles.administradorDemo}>Administrador Demo</p>
          </div>
          <div className={styles.button2}>
            <img src="../image/mi2ttl3g-flq5z3b.svg" className={styles.icon5} />
          </div>
        </div>
      </div>
      <div className={styles.chatbotWidget}>
        ...
        <div className={styles.button3}>
          <img src="../image/mi2ttl3g-h8ojfbb.svg" className={styles.icon5} />
        </div>
      </div>
    </div>
  );
